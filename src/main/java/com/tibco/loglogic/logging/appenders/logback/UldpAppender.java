...
/**
 * LogBack Appender for sending logs using Syslog/ULDP
 *
...
public class UldpAppender
    ...
    private UldpConnectionSettings uldpConnectionSettings = new UldpConnectionSettings( "" );

    private UldpForwarderSettings settings = new UldpForwarderSettings( uldpConnectionSettings );
    ...
    protected LogForwarder createForwarder() {
        return new UldpForwarder( settings );
    }
